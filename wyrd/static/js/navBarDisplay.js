...
(() => {
  ...
  // shared variable with other UI scripts
  ...
  function updateSharedNavHeight() {
    window.wyrdUi.navHeight = navBar?.getBoundingClientRect().height || 0;
    return window.wyrdUi.navHeight;
  }
  ...
  function initNavColorSwitching() {
    ...
    desktopMedia.addEventListener("change", updateSharedNavHeight);
  }
